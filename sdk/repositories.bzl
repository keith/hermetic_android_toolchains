...
def _common_platforms(build_tools_platforms, platform_tools_platforms):
    platforms = sorted([platform for platform in build_tools_platforms if platform in platform_tools_platforms])
    if not platforms:
        fail("Android SDK build_tools and platform_tools archives have no platforms in common: build_tools [{}], platform_tools [{}].".format(
            _format_platforms(build_tools_platforms),
            _format_platforms(platform_tools_platforms),
        ))
    return platforms
